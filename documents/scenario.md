...
- **챔피언 정보**에는 **챔피언 역할군, 레벨 별 능력치, 스킬 정보, 추천 룬과 스펠, 추천 라인과 아이템 트리, 출시된 스킨, 챔피언 설명, 카운터픽 및 한줄평** 이 있다.
...
- 챔피언 정보에서는 와일드 리프트에 기본 저장된 아이템 트리를 보여주고 공략 게시판과 연결되어 공략 게시글의 좋아요 순으로 최대 10개까지 보여준다.
